...
def main(args):
    ...
    match args.command:
        ...
        case "create":
            dm.create_dataset(args.data_paths, args.chosen_paths, args.dataset_name, args.split, args.resize, args.labels, args.step, args.start_index, args.delete, args.cluster_method)
        case "extract_log":
