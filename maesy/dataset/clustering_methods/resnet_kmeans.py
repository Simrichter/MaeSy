...
def cluster(paths, n_C, batch_size=256, forward_scale=224, step=1, start_index=0):
    ...
    multi_dataset = MultiDataset([UnlabeledDataset(images_dir=path, transforms=transfs, filetype=".jpg", step=step, start_index=start_index, use_first_n=10000) for path in paths])
