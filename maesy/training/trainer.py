...
class Trainer:
    """Trainer for Vision Transformer object detection."""
    ...
    def __init__(
        ...
        self.criterion = DetectionLoss(
            ...
            bbox_loss_coef=model.config.bbox_loss_coef,
            class_loss_coef=model.config.class_loss_coef,
            giou_loss_coef=model.config.giou_loss_coef
        )
